...
<body>
	<div class="body_wrapper">
		<div class="header">
			<h1 style=" text-align: center; color: black;">Mobile Sansaar Login</h1>            
		</div>
		<hr>
		<p><a href="index.php" style="text-decoration: none; padding-left: 10px;">Mobile</a> &raquo; Login</p>
		<div class="content" style="text-align: center;">
			<form action="" method="POST">
			<!-- value="ersks"  -->	
			<!-- user anil --><input type="text" name="username"  id="lf" required="required" autofocus="true"><br>
